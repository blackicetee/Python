...
from machine_learing_games.Agents.LearningAgents.TicTacToeTDQLearningAgent import TICTACTOE_4x4_TDQ_AGENT_100_NAME, \
    TicTacToeTDQLearningAgent, TICTACTOE_4x4_TDQ_AGENT_1000_NAME, TICTACTOE_4x4_TDQ_AGENT_10000_NAME
from machine_learing_games.tictactoe.TicTacToe import TicTacToe


class TestTDQAgent100TrainingGamesIn16FiledTicTacToe(unittest.TestCase):
    def testAgainstFirstMoveRandomAgentIn100Testgames(self):
        randomAgentWins = 0
        tdqAgent100Wins = 0
        for testGameCount in range(100):
            ttt = TicTacToe(4)
            tdqAgent100 = TicTacToeTDQLearningAgent(TICTACTOE_4x4_TDQ_AGENT_100_NAME, 4)
        ...
        print 'First Move random agent wins: ' + str(
            randomAgentWins) + ' games against TD-Q-Agent-100 in 16 field Tic Tac Toe!'
        print 'Second Move TD-Q-Agent-100 wins: ' + str(
            tdqAgent100Wins) + ' games against random agent in 16 field Tic Tac Toe!'
    ...
    def testAgainstFirstMoveHeuristikAgentIn100Testgames(self):
        ...
        print 'First move heuristic search agent wins: ' + str(
            heuristicSearchAgentWins) + ' games against TD-Q-Agent-100 in 16 field Tic Tac Toe!'
        print 'Second move TD-Q-Agent-100 wins: ' + str(
            tdqAgent100Wins) + ' games against heuristic search agent in 16 field Tic Tac Toe!'
        self.assertTrue(tdqAgent100Wins >= 50)
...
class TestTDQAgent1000TrainingGamesIn16FiledTicTacToe(unittest.TestCase):
    def testAgainstFirstMoveRandomAgentIn100Testgames(self):
        randomAgentWins = 0
        tdqAgent1000Wins = 0
        for testGameCount in range(100):
            ttt = TicTacToe(4)
            tdqAgent1000 = TicTacToeTDQLearningAgent(TICTACTOE_4x4_TDQ_AGENT_1000_NAME, 4)
            while not ttt.is_terminal():
                RandomAgent.processTicTacToeAction(ttt)
                if not ttt.is_terminal():
            ...
            if ttt.is_victory() and ttt.get_player_which_moved_last() == 'X':
                ...
                tdqAgent1000Wins += 1
        print 'First Move random agent wins: ' + str(
            randomAgentWins) + ' games against TD-Q-Agent-1000 in 16 field Tic Tac Toe!'
        print 'Second Move TD-Q-Agent-1000 wins: ' + str(
            tdqAgent1000Wins) + ' games against random agent in 16 field Tic Tac Toe!'
    ...
    def testAgainstFirstMoveHeuristikAgentIn100Testgames(self):
        ...
        for testGameCount in range(100):
            ...
            if ttt.is_victory() and ttt.get_player_which_moved_last() == 'X':
                ...
                tdqAgent1000Wins += 1
        print 'First move heuristic search agent wins: ' + str(
            heuristicSearchAgentWins) + ' games against TD-Q-Agent-1000 in 16 field Tic Tac Toe!'
        print 'Second move TD-Q-Agent-1000 wins: ' + str(
            tdqAgent1000Wins) + ' games against heuristic search agent in 16 field Tic Tac Toe!'
        self.assertTrue(tdqAgent1000Wins >= 50)
...
class TestTDQAgent10000TrainingGamesIn16FiledTicTacToe(unittest.TestCase):
    def testAgainstFirstMoveRandomAgentIn100Testgames(self):
        randomAgentWins = 0
        tdqAgent10000Wins = 0
        for testGameCount in range(100):
            ttt = TicTacToe(4)
            tdqAgent10000 = TicTacToeTDQLearningAgent(TICTACTOE_4x4_TDQ_AGENT_10000_NAME, 4)
            while not ttt.is_terminal():
                RandomAgent.processTicTacToeAction(ttt)
                if not ttt.is_terminal():
            ...
            if ttt.is_victory() and ttt.get_player_which_moved_last() == 'X':
                ...
                tdqAgent10000Wins += 1
        print 'First Move random agent wins: ' + str(
            randomAgentWins) + ' games against TD-Q-Agent-10000 in 16 field Tic Tac Toe!'
        print 'Second Move TD-Q-Agent-10000 wins: ' + str(
            tdqAgent10000Wins) + ' games against random agent in 16 field Tic Tac Toe!'
    ...
    def testAgainstFirstMoveHeuristikAgentIn100Testgames(self):
        ...
        for testGameCount in range(100):
            ...
            if ttt.is_victory() and ttt.get_player_which_moved_last() == 'X':
                ...
                tdqAgent10000Wins += 1
        print 'First move heuristic search agent wins: ' + str(
            heuristicSearchAgentWins) + ' games against TD-Q-Agent-10000 in 16 field Tic Tac Toe!'
        print 'Second move TD-Q-Agent-10000 wins: ' + str(
            tdqAgent10000Wins) + ' games against heuristic search agent in 16 field Tic Tac Toe!'
        self.assertTrue(tdqAgent10000Wins >= 50)
