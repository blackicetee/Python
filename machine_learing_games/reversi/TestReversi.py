...
class TestCountTokensWithAdjacentFreeSpace(unittest.TestCase):
    def test_count_of_black_tokens_with_adjected_free_space(self):
        ...
        self.assertEqual(reversi.count_black_tokens_with_adjacent_free_space(), 10)
    ...
    def test_count_of_white_tokens_with_adjected_free_space(self):
        ...
        self.assertEqual(reversi.count_white_tokens_with_adjacent_free_space(), 11)
